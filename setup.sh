...
echo "peer0.shipper.tfbc.com joining the channel..."
# Join peer0.shipper.tfbc.com to the channel.
docker exec -e "CORE_PEER_LOCALMSPID=ShipperMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/shipper.tfbc.com/users/Admin@shipper.tfbc.com/msp" -e "CORE_PEER_ADDRESS=peer0.shipper.tfbc.com:7051" cli peer channel join -b tfbcchannel.block
sleep 5

echo "peer0.shipper.tfbc.com joined the channel"

echo "peer0.customes.tfbc.com joining the channel..."
# Join peer0.customes.tfbc.com to the channel.
docker exec -e "CORE_PEER_LOCALMSPID=CustomesMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/customes.tfbc.com/users/Admin@customes.tfbc.com/msp" -e "CORE_PEER_ADDRESS=peer0.customes.tfbc.com:7051" cli peer channel join -b tfbcchannel.block
sleep 5

echo "peer0.customes.tfbc.com joined the channel"
...
echo "Installing tfbc chaincode to peer0.shipper.tfbc.com..."
# Install code on seller peer
docker exec -e "CORE_PEER_LOCALMSPID=ShipperMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/shipper.tfbc.com/users/Admin@shipper.tfbc.com/msp" -e "CORE_PEER_ADDRESS=peer0.shipper.tfbc.com:7051" cli peer chaincode install -n tfbccc -v 1.0 -p github.com/tfbc/go -l golang

sleep 5

echo "Installed tfbc chaincode to peer0.shipper.tfbc.com"

echo "Installing tfbc chaincode to peer0.customes.tfbc.com..."
# Install code on seller peer
docker exec -e "CORE_PEER_LOCALMSPID=CustomesMSP" -e "CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/customes.tfbc.com/users/Admin@customes.tfbc.com/msp" -e "CORE_PEER_ADDRESS=peer0.customes.tfbc.com:7051" cli peer chaincode install -n tfbccc -v 1.0 -p github.com/tfbc/go -l golang

sleep 5

echo "Installed tfbc chaincode to peer0.customes.tfbc.com"
